...
ice_df = fetch_climate_data("no_ice_days", "ice_para")
summer_df = fetch_climate_data("no_summer_days", "summer_para")
extrain_df = fetch_climate_data("no_days_acc_precip_10", "extrain_para")
...
merged_data.to_csv(f"{directory}/climate_parameters_municipality_combined_v2.csv", index=False)